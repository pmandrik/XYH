...
# for cut in "" "lf" "hf"; do
for cut in "lf" "hf"; do
  root -l -b -q "process_delphes.cpp(\""$file_ttbar"\",\"pd_file_650_MY_375_"$cut".root\", \"\", \"csv_tbar.csv\" ,\"$path_train/eval2_ttbar_MX_650_MY_375.txt\", \""$cut"\")"
  root -l -b -q "process_delphes.cpp(\""$file_ttbar"\",\"pd_file_900_MY_600_"$cut".root\", \"\", \"csv_tbar.csv\" ,\"$path_train/eval2_ttbar_MX_900_MY_600.txt\", \""$cut"\")"
  root -l -b -q "process_delphes.cpp(\""$file_ttbar"\",\"pd_file_1300_MY_475_"$cut".root\", \"\", \"csv_tbar.csv\" ,\"$path_train/eval2_ttbar_MX_1300_MY_475.txt\", \""$cut"\")"
  root -l -b -q "process_delphes.cpp(\""$file_ttbar"\",\"pd_file_1300_MY_975_"$cut".root\", \"\", \"csv_tbar.csv\" ,\"$path_train/eval2_ttbar_MX_1300_MY_975.txt\", \""$cut"\")"
  root -l -b -q "process_delphes.cpp(\""$file_ttbar"\",\"pd_file_1700_MY_475_"$cut".root\", \"\", \"csv_tbar.csv\" ,\"$path_train/eval2_ttbar_MX_1700_MY_475.txt\", \""$cut"\")"
  root -l -b -q "process_delphes.cpp(\""$file_ttbar"\",\"pd_file_1700_MY_1225_"$cut".root\", \"\", \"csv_tbar.csv\" ,\"$path_train/eval2_ttbar_MX_1700_MY_1225.txt\", \""$cut"\")"
  root -l -b -q "process_delphes.cpp(\""$file_ttbar"\",\"pd_file_1900_MY_475_"$cut".root\", \"\", \"csv_tbar.csv\" ,\"$path_train/eval2_ttbar_MX_1900_MY_475.txt\", \""$cut"\")"
  root -l -b -q "process_delphes.cpp(\""$file_ttbar"\",\"pd_file_1900_MY_1600_"$cut".root\", \"\", \"csv_tbar.csv\" ,\"$path_train/eval2_ttbar_MX_1900_MY_1600.txt\", \""$cut"\")"
done;
exit
